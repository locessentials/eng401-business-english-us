---
layout: default
title: Document Analysis Assignment
parent: Week 13
grand_parent: Unit 5
nav_order: 4
---
...
| ------------------------------- | --------------------------------- |
| - **Master Services Agreements (MSAs)**: Overarching contracts that establish general terms for ongoing business relationships<br>- **Statements of Work (SOWs)**: Detailed project-specific documents defining scope, deliverables, and timeline<br>- **Letters of Intent (LOIs)**: Preliminary agreements expressing serious intention to enter a business relationship<br>- **Licensing Agreements**: Contracts granting rights to use intellectual property, software, or branded materials<br>- **Distribution Agreements**: Contracts establishing terms for distributing products in specific markets or territories | - **Requests for Information (RFIs)**: Preliminary documents gathering general information about vendor capabilities<br>- **Requests for Quotation (RFQs)**: Documents requesting specific pricing for well-defined products or services<br>- **Vendor Qualification Questionnaires**: Assessment documents used to evaluate potential suppliers<br>- **Supplier Code of Conduct**: Documents establishing ethical and operational standards for suppliers<br>- **Vendor Scorecards/Performance Reviews**: Structured evaluations of supplier performance |
...
1. Explain the document's purpose and context
2. Describe its standard structure and components
3. Define key vocabulary and terminology
4. Share observations from comparing your examples
...
1. **Title page** (optional but professional): Document type, group members' names, date
2. **Your analysis** (1-2 pages)
3. **Example documents** (attached after the analysis)
4. **Works consulted** (list where you found each example, can be a simple bulleted list)
...
**Week 13 Complete!** Next week we'll explore [Digital Business Tools & Technology](../week14/week14-overview.md)
