...
**Source:** [6 Tips for Productive 1:1 Meetings with Your Manager](https://youtu.be/LWz57CpcSnE?si=iG_ssqfrZxa5P1By)
...
**Source:** [ONE-ON-ONE MEETINGS WITH EMPLOYEES](https://youtu.be/JEzuTVurZ1o?si=wynArBPZ9RhjrtlB)
...
Following [D2L's Employee Development Plans](https://www.d2l.com/blog/employee-development-plan), quickly design a [SMART system](https://en.wikipedia.org/wiki/SMART_criteria) for addressing a business challenge you'd like to solve. Design your system based on the following format from D2L.
...
| Manager readiness check | What do you need to know to be able to do that?<br>What preparation do you need to do to address the challenge? |
...
- [JAN Role-Play Training Series: Performance Management](https://youtu.be/0LpQjI_8mQI?si=sD1AJpj_0DWZOeku) - A role play on open and honest communication leading to performance improvements for both managers and employees
