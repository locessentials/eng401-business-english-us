...
**Listen to this segment from "A Way with Words" radio show:** [Herod Clause](https://waywordradio.org/herod-clause/)
...
**Watch this presentation about real problematic clauses encountered in the translation industry:** [Red Flags in Localization Contracts](https://www.youtube.com/watch?v=shamGJQFAKA)

### Key Examples from the Video

**The Multiple Choice Question:**
If you had signed the Loc101 NDA from our previous activity, what rights would you have accidentally given up?

A. Freedom to work at another employer in the localization field
B. Ability to speak an idea aloud during an interview without your potential employer claiming rights to it  
C. Freedom from monetary damages for your work as an intern
D. Right to be paid for work performed
E. Full, royalty-free, perpetual, irrevocable, worldwide, non-exclusive, and fully sublicensable right and license to use, reproduce, display, distribute, adapt, modify, create derivative works of, and otherwise commercially or non-commercially exploit in any way, any and all intellectual property
...
**Next Activity:** [Understanding Typical Contracts](understanding-typical-contracts.md)
