---
layout: default
title: Corporate Communications Portfolio Assignment
parent: Week 11
grandparent: Unit 4
nav_order: 4
---
...
**Scenario A: Technology Migration**
...
**Scenario C: Organizational Restructuring**
...
For each document:
1. **Choose appropriate tone and register** for the audience and context
2. **Structure information logically** using the format conventions of that text type
3. **Address audience-specific concerns** while maintaining consistent messaging
4. **Use clear, accessible language** appropriate for business communication
5. **Include relevant details** without overwhelming readers
6. **Follow principles** from this week's readings:
...
1. **Introduces your scenario** and explains why you chose it
2. **Analyzes each document individually** (POV, audience, text type, effectiveness)
3. **Synthesizes your communication strategy** (how documents work together, timing, gaps)
...
**Week 11 Complete!** Next week we'll explore [Leadership and Performance Management](../week12/week12-overview.md)
