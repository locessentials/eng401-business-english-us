---
layout: default
title: Tranquality's Translation Specifications
parent: Week 7
grand_parent: Unit 3
nav_order: 3
---

# Tranquality's Standards-Based Structured Translation Specifications
...
#### 21. **Expectations**
   1. **Compensation** (typically costs)
   2. **Communication** (channels and mode among stakeholders)

**Notes:** In 1, 7 and 8: The audience and the purpose can be plural in some cases. Tasks defined in 14c (revision, review, proofreading) that can follow initial translation were taken from ISO 17100.

---

*This page is a recreation of the specifications found here: [https://www.tranquality.info/specs/](https://www.tranquality.info/specs/)*

---

**Next Activity**: [Technical Specifications Assignment](technical-specifications-assignment.md)
