---
layout: default
title: Understanding Typical Contracts
parent: Week 4
grand_parent: Unit 2
nav_order: 3
---
...
**Review the NDA from our [previous activity](class-nda.md)** - this is a example of an NDA used for educational purposes.
...
**Based on [American Translators Association (ATA) model contract](https://github.com/alainamb/uic_tr35-business-english-II/blob/main/unit2/week4/references/ATA-ICA-Example.pdf) used until 2022**
...
### Example 3: [Purchase Order](https://github.com/alainamb/uic_tr35-business-english-II/blob/main/unit2/week4/references/PO-Example.pdf)
...
**Credit the Translator Movement**
Professional organizations worldwide advocate for:
...
**Emily Cipriani's Reflection on Signing the Loc101 NDA**
*"My sister was waiting at the doctor's office one day when the fire alarm went off. People looked around at each other, shrugged, and stayed in their chairs. A few minutes later, a doctor came out, saying, 'The alarm is beeping! You need to leave!' In the safety of a classroom, I fell under the influence of [Normalcy Bias](https://en.wikipedia.org/wiki/Normalcy_bias); I wasn't on guard to notice the obvious warning signs, and when peers signed quickly, I did too."*
...
- ["Unraveling Translation Service Contracts" by Paula Arturo](https://www.atanet.org/resources/unraveling-translation-service-contracts/)
...
**Next Activity:** [Assignment: Negotiate a Contract](assignment-negotiate-contract.md) where you'll practice negotiating contract terms.
