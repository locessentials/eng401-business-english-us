...
1. **Professional presentation slides** (8-10 slides)
2. **Comprehensive written report** (~1500 words)
3. **Recorded presentation delivery** (8-12 minutes)
4. **Peer evaluations** (optional but recommended)
